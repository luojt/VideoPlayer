...
import com.luo.videoplayer.base.BaseVideoController;
import com.luo.videoplayer.utils.Logger;


/**
 * title：VideoMiniWindowController
 * description：小窗控制器
 * author：luojiongtian on 2020/4/17 10:35
 */
public class VideoMiniWindowController extends BaseVideoController {
    ...
    public VideoMiniWindowController(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        //退出小窗口
        findViewById(R.id.video_btn_back_tiny).setOnClickListener(new View.OnClickListener() {
            @Override
